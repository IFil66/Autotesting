package com.capital.testsWithAllure.tradingInstrumentCards_tests.EN.forex;
...
public class CheckRegBtnTicForexTests extends MethodsWithAllure {
  ...
  @ParameterizedTest
  @CsvFileSource(files = "src/test/resources/data/tradingInstrumentCards/csvFiles/forexTicName.csv", numLinesToSkip = 1)
