package com.capital.testsWithAllure.tradingInstrumentCards_tests.EN.indices;
...
public class CheckRegBtnTicIndicesTests extends MethodsWithAllure {
  ...
  @ParameterizedTest
  @CsvFileSource(files = "src/test/resources/data/tradingInstrumentCards/csvFiles/indicesTicName.csv", numLinesToSkip = 1)
