...
public class CheckRegBtnTicCryptocurrenciesTests_4 extends MethodsWithAllure {

  @ParameterizedTest
  @CsvFileSource(files = "src/test/resources/data/tradingInstrumentCards/csvFiles/cryptocurrenciesTicName4.csv", numLinesToSkip = 1)
