package com.capital_tests.testsWithAllure.tradingInstrumentCards_tests.EN.cryptocurrencies;
...
public class CheckRegBtnTicCryptocurrenciesTests_2 extends MethodsWithAllure {
  ...
  @ParameterizedTest
  @CsvFileSource(files = "data/tradingInstrumentCards/csvFiles/cryptocurrenciesTicName-2.csv", numLinesToSkip = 1)
